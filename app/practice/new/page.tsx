      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8">
        <header className="flex flex-wrap items-center justify-between gap-4">
          ...
          <nav className="flex flex-wrap gap-3">
            ...
            <Link href="/vocab" className="pill pill-ghost bg-white">
              Vokabelliste
            </Link>
          </nav>
        </header>

        <section className="card surface-green p-6">
          <div className="grid gap-4 md:grid-cols-3">
            <label className="flex flex-col gap-2 text-sm text-[color:var(--ink-primary)]">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <label className="flex flex-col gap-2 text-sm text-[color:var(--ink-primary)]">
              ...
              <div className="flex gap-2">
                <button
                  type="button"
                  className={`pill ${japaneseDisplay === "kana" ? "pill-primary" : "pill-ghost bg-white"}`}
                ...
                <button
                  type="button"
                  className={`pill ${japaneseDisplay === "kanji" ? "pill-primary" : "pill-ghost bg-white"}`}
            ...
            <label className="flex items-center gap-3 text-sm text-[color:var(--ink-primary)]">
              <input
                type="checkbox"
